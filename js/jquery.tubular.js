...
jQuery.fn.tubular = function(videoId,wrapperId) {
	...
	var iframe = '<iframe id="myytplayer" width="' + videoWidth + '" height="' + videoHeight + '" src="http://www.youtube.com/embed/' + videoId + '?autoplay=1&loop=1&playlist=' + videoId + '" frameborder="0" allowfullscreen></iframe>';
